defmodule PhoenixSeaBattleWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {PhoenixSeaBattleWeb.LayoutView, :root}
  ...
  # scope "/api", PhoenixSeaBattleWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: PhoenixSeaBattleWeb.Telemetry
    end
  end
end
